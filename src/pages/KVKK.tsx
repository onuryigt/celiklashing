            ...
            <div className="prose prose-lg prose-gray max-w-none">
              ...
              >
                ...
                <div className="space-y-12">
                  <div>
                    <h2 className="text-2xl font-bold text-steel-900 mb-4">1. Kişisel Verilerin Korunması ve İşlenmesi Politikasının Amacı</h2>
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-steel-900 mb-4">2. Kişisel Verilerin İşlenme İlkeleri</h2>
                    <div className="space-y-4">
                      <p className="text-steel-600">Kişisel veriler aşağıdaki ilkeler doğrultusunda işlenmektedir:</p>
                      <ul className="list-disc pl-6 space-y-2 text-steel-600">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-steel-900 mb-4">3. Kişisel Verilerin İşlenme Amaçları</h2>
                    <div className="space-y-4">
                      <p className="text-steel-600">Kişisel verileriniz aşağıdaki amaçlarla işlenmektedir:</p>
                      <ul className="list-disc pl-6 space-y-2 text-steel-600">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-steel-900 mb-4">4. Kişisel Verilerin Aktarılması</h2>
                    <p className="text-steel-600 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-steel-900 mb-4">5. Kişisel Veri Sahibinin Hakları</h2>
                    <p className="text-steel-600 mb-6">
                    ...
                    <div className="bg-steel-50 rounded-sm p-6 space-y-3">
                      <p className="text-steel-600">Bu kapsamda kişisel veri sahipleri;</p>
                      <ul className="list-disc pl-6 space-y-2 text-steel-600">
