    ...
    <div className="min-h-screen bg-steel-50">
      ...
      <section className="relative bg-steel-900 text-white pt-36 pb-20 overflow-hidden">
        <motion.div
          ...
          className="absolute inset-0 bg-[url('/hero2.webp')] bg-cover bg-center"
        />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-white rounded-sm shadow-xl p-8 md:p-12">
            <div className="prose prose-lg prose-gray max-w-none">
              ...
              >
                <div className="bg-secure/5 border-l-4 border-secure p-6 rounded-r-lg mb-8">
                  <p className="text-steel-700 m-0">
                ...
                <div className="space-y-12">
                  <div>
                    <h2 className="text-2xl font-bold text-steel-900 mb-4">İnternet Sitesinde Kullanılan Çerezler</h2>
                    
                    <h3 className="text-xl font-semibold text-steel-900 mb-3">Çerez Nedir ve Neden Kullanılmaktadır?</h3>
                    <p className="text-steel-600 mb-4">
                      Çerezler, ziyaret ettiğiniz internet siteleri tarafından tarayıcılar aracılığıyla cihazınıza veya ağ sunucusuna depolanan küçük metin dosyalarıdır.
                    </p>

                    <p className="text-steel-600 mb-6">İnternet Sitemizde çerez kullanılmasının başlıca amaçları aşağıda sıralanmaktadır:</p>
                    <ul className="list-disc pl-6 space-y-2 text-steel-600 mb-8">
                    ...
                    <h3 className="text-xl font-semibold text-steel-900 mb-3">İnternet Sitemizde Kullanılan Çerez Türleri</h3>
                    
                    <div className="space-y-6">
                      <div className="bg-steel-50 rounded-sm p-6">
                        <h4 className="font-semibold text-steel-900 mb-2">Oturum Çerezleri (Session Cookies)</h4>
                      ...
                      <div className="bg-steel-50 rounded-sm p-6">
                        <h4 className="font-semibold text-steel-900 mb-2">Kalıcı Çerezler (Persistent Cookies)</h4>
                        <p className="text-steel-600">
                      ...
                      <div className="bg-steel-50 rounded-sm p-6">
                        <h4 className="font-semibold text-steel-900 mb-2">Teknik Çerezler</h4>
                        <p className="text-steel-600">
                      ...
                      <div className="bg-steel-50 rounded-sm p-6">
                        <h4 className="font-semibold text-steel-900 mb-2">Otantikasyon Çerezleri</h4>
                        <p className="text-steel-600">
                      ...
                      <div className="bg-steel-50 rounded-sm p-6">
                        <h4 className="font-semibold text-steel-900 mb-2">Analitik Çerezler</h4>
                        <p className="text-steel-600">
